...
<body class="hold-transition sidebar-mini">
                        ...
                        <?php if($rowCount > 0){?>
                                ...
                                <?php for($i=1; $i<=$pages; $i++){?>
                                    <li class="page-item" style="clear: both !important">
                                        <a class="page-link" <?php if($i == $page) {?>style="background: #ccc;"<?php }?>
                                            href="random.php?searchCategory=<?php echo $searchCategory; ?>&searchCountry=<?php echo $searchCountry; ?>&searchKeyword=<?php echo $searchKeyword; ?>&searchOrigin=<?php echo $searchOrigin; ?>&isMturk=<?php echo $isMturk; ?>&isDraft=<?php echo $isDraft; ?>&isStar=<?php echo $isStar; ?>&page=<?php echo $i;?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php } ?>
                                        ...
                                        <td><div id="questionInfo<?php echo $id;?>"></div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <br>
                                                    <small>Likes/Dislikes: <?php echo $likes; ?> / <?php echo $dislikes; ?></small>
                                                    <br>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <br>
                                                    <small>Ingame Occurrence: <?php echo $ingame_occurrence; ?></small>
                                                    <br>
                            ...
                            <small>Page <?php echo $page;?> of <?php echo $pages;?></small>
                                ...
                                <?php for($i=1; $i<=$pages; $i++){?>
                                    <li class="page-item" style="clear: both !important">
                                        <a class="page-link" <?php if($i == $page) {?>style="background: #ccc;"<?php }?>
                                        href="random.php?searchCategory=<?php echo $searchCategory; ?>&searchCountry=<?php echo $searchCountry; ?>&searchKeyword=<?php   $searchKeyword; ?>&searchOrigin=<?php echo $searchOrigin; ?>&isMturk=<?php echo $isMturk; ?>&isDraft=<?php echo $isDraft; ?>&isStar=<?php echo $isStar; ?>&page=<?php echo $i;?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php } ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form">
                        ...
                        <div class="form-group row mt-4 justify-content-md-center">
                            <div class="col-md-10">
                                <label for="Question">Answer Info:</label>
                                <textarea class="form-control" id="answer_infoCreate" rows="10" name="answer_infoCreate"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-4 justify-content-md-center">
                            <div class="col-md-10">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#isStar').click(function() {
                if($('#isNoStar').prop('checked')) {
                    $('#isNoStar').prop('checked', false);
                }
            });
            $('#isNoStar').click(function() {
                if($('#isStar').prop('checked')) {
                    $('#isStar').prop('checked', false);
                }
            });

            $('#clearScrapData').click(function(e){
                e.preventDefault();
                $('#scrap_answer').val('');
                $('#answer_info').val('');
                $('#scrap_title').val('');
                $('#scrap_image').attr('src', '../../assets/img/placeholder-300x200.jpg');
                $('#scrap_image').attr('title', '');
                $('#scrap_image').attr('alt', '');
        ...
        function populateCountries() {
            var countryUrl ="https://seniorsdiscountclub.com.au/games/trivia/data/countries.json";
            $.ajax({
                dataType: "json",
                url: countryUrl,
        ...
        function submitCreateQuestion() {
            ...
            var answer_info = $('#answer_infoCreate').val();
