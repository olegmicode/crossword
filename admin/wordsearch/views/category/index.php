...
<body class="hold-transition sidebar-mini">
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mt-1">All Categories</h3>

                        <div class="card-tools">
                            <a href="#" class="btn btn-sm btn-success btnAdd">Add new Category</a>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form role="form">
                        <div class="form-group row mt-4 justify-content-md-center">
                            <div class="col-md-10">
                                <label for="width">Category Name:</label>
                                <input class="form-control" id="categoryNameCreate" type="text" name="categoryNameCreate" placeholder="Enter the category name" required></input>
                            </div>
                        </div>

                        <div class="form-group row mt-4 justify-content-md-center">
                            <div class="col-md-10">
                                <button type="submit" id="submitCreateCategory" class="btn btn-success">Save Changes</button>
                            </div>
                        </div>
                        <div class="form-group row mt-4 justify-content-md-center">
                            <div class="col-md-10">
                                ...
                                <div class="alert alert-danger" id="error-alert-create" style="display: none">
                                    <button type="button" class="close" data-dismiss="alert">x</button>
                                    <strong>Cannot add new data, its already exist in database.</strong>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        function submitCreateCategory() {
            var categoryName = $('#categoryNameCreate').val();
            ...
            if(categoryName != '') {
                ...
                var ajaxUrl = apiUrl + '/category/submit-category.php';
        ...
        function deleteCategory(id) {
            if(id != '') {
                ...
                var ajaxUrl = apiUrl + '/category/delete.php';

                $('#CategoryInfo'+id).html("deleting....<hr>");
