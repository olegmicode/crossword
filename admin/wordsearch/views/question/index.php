...
<body class="hold-transition sidebar-mini">
                        ...
                        <?php if($rowCount > 0){?>
                            ...
                            <div style="overflow-x: scroll; margin-top: 20px">
                                ...
                                <?php for($i=1; $i<=$pages; $i++){?>
                                    <li class="page-item" style="clear: both !important">
                                        <a class="page-link" <?php if($i == $page) {?>style="background: #ccc;"<?php }?>
                                            href="index.php?searchCategory=<?php echo $searchCategory; ?>&searchCountry=<?php echo $searchCountry; ?>&searchKeyword=<?php $searchKeyword; ?>&searchOrigin=<?php $searchOrigin; ?>&&isMturk=<?php $isMturk; ?>&isDraft=<?php $isDraft; ?>&isStar=<?php $isStar; ?>&page=<?php echo $i;?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php } ?>
    ...
    <script>
        ...
        if (location.hostname === "localhost" || location.hostname === "127.0.0.1") {
            var apiUrl = 'http://localhost/ylc-games/woordsearch/api';
        } else {
