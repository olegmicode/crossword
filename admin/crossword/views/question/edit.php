...
<!-- ./wrapper -->
    ...
    function submitQuestion() {
        ...
        if(category != '' && question != '' && question_source !='' && correct_answer != '' && incorrect_answer_1 != '' && incorrect_answer_2 != '' && incorrect_answer_3 != '') {
            ...
            var ajaxUrl = 'https://seniorsdiscountclub.com.au/games/crossword/api/question/update.php';
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
                        ...
                        window.location.href = "https://seniorsdiscountclub.com.au/games/admin/crossword/views/question/";
                    });
                },
