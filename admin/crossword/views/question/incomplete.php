                        ...
                        <?php if($rowCount > 0){?>
                                ...
                                <?php for($i=1; $i<=$pages; $i++){?>
                                    <li class="page-item" style="clear: both !important">
                                        <a class="page-link" <?php if($i == $page) {?>style="background: #ccc;"<?php }?>
                                            href="incomplete.php?searchCategory=<?php echo $searchCategory; ?>&searchCountry=<?php echo $searchCountry; ?>&searchKeyword=<?php $searchKeyword; ?>&searchOrigin=<?php $searchOrigin; ?>&&isMturk=<?php $isMturk; ?>&isDraft=<?php $isDraft; ?>&isStar=<?php $isStar; ?>&page=<?php echo $i;?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php } ?>
                            ...
                            <table class="table table-striped" id="questionData">
                                ...
                                while ($row = $statement->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    $lastChar = substr(trim($question), -1);
