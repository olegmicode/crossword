                                ...
                                <?php for($i=1; $i<=$pages; $i++){?>
                                    <li class="page-item" style="float: left">
                                        <a class="page-link" <?php if($i == $page) {?>style="background: #ccc;"<?php }?>
                                            href="deleted.php?searchCategory=<?php echo $searchCategory; ?>&searchCountry=<?php echo $searchCountry; ?>&searchKeyword=<?php $searchKeyword; ?>&searchOrigin=<?php $searchOrigin; ?>&&isMturk=<?php $isMturk; ?>&isDraft=<?php $isDraft; ?>&isStar=<?php $isStar; ?>&page=<?php echo $i;?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php } ?>
