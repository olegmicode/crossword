...
<body class="hold-transition sidebar-mini">
                                ...
                                <div class="col">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?php echo $scoreList[$i]['score'] ;?></td>
    ...
    <script>
        ...
        if (location.hostname === "localhost" || location.hostname === "127.0.0.1") {
            var apiUrl = 'http://localhost/ylc-games/solitaire/administrator/api';
        } else {
            var apiUrl = 'https://seniorsdiscountclub.com.au/games/solitaire/administrator/api';
        }
