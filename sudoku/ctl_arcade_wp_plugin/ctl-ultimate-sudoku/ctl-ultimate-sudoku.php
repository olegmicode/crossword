<?php
    /*
    Plugin Name: CTL Arcade - Ultimate Sudoku
    Plugin URI: http://www.codethislab.com/
    Description: Ultimate Sudoku for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeUltimateSudoku {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-ultimate-sudoku";
        private $_szPluginName              = "UltimateSudoku";
        private $_szAspectRatio             = "9:16";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "board game, brain game, crossword, grid, html5 board game, html5 sudoku, math game, numbers, sudoku";
    ...
    $g_oCTLArcadeUltimateSudoku =  new CTLArcadeUltimateSudoku();