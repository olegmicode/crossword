...
include_once '../../../admin/solitaire/config/database.php';
  
// instantiate object
include_once '../../../admin/solitaire/objects/score.php';
include_once '../../../admin/solitaire/objects/UserSetting.php';
...
$message = '';
$scoreObj->user_key = 'YLCGamesSolitaire-User-' . date('Ymdhis');
