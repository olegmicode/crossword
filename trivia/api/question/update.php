...
if(
    ...
    $question->answer_info = !empty($data->answer_info) ? $data->answer_info : "";
    $question->scrap_title = !empty($data->scrap_title) ? $data->scrap_title : "";
    $question->scrap_answer = !empty($data->scrap_answer) ? $data->scrap_answer : "";
